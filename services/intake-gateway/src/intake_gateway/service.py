...
class IntakeService:
    ...
    async def ingest(self, filename: str, content_type: str, content: bytes) -> DocumentCreated:
        with tracer.start_as_current_span("intake.ingest") as span:
            ...
            # Р СџРЎС“Р В±Р В»Р С‘Р С”Р В°РЎвЂ Р С‘РЎРЏ Р Р† Kafka РІР‚вЂњ Р С•Р С—РЎвЂ Р С‘Р С•Р Р…Р В°Р В»РЎРЉР Р…Р С• (Р СР С•Р В¶Р ВµРЎвЂљ Р В±РЎвЂ№РЎвЂљРЎРЉ Р Р…Р ВµР Т‘Р С•РЎРѓРЎвЂљРЎС“Р С—Р Р…Р В° Р Р† РЎвЂљР ВµРЎРѓРЎвЂљР В°РЎвЂ¦)
            try:
